...
insert into Animal (nom_animal,type_animal,race,age,description,mail_proprio) values ("Bibi","Chat","Siamois",4,"petit mignon câlin chaton beau mâle", "victorinf3005@gmail.com");
...
insert into Animal (nom_animal,type_animal,race,age,description,mail_proprio) values ("Vino","Chat","créole",11,"gors matou mâle chat sensible","mathieuinf3005@gmail.com");
insert into Animal (nom_animal,type_animal,race,age,description,mail_proprio) values ("Link","Ecureuil","allemand",1,"petit mignon coquin beau mâle", "subaninf3005@gmail.com");
insert into Animal (nom_animal,type_animal,race,age,description,mail_proprio) values ("Mario","Tortue","muette",119,"timide sanguinaire câlin myope mâle", "nintendoinf3005@gmail.com");
insert into Animal (nom_animal,type_animal,race,age,description,mail_proprio) values ("Sonic","Herisson","Piquant",44,"vieux Hérisson Grincheux sublime  mâle", "segainf3005@gmail.com");
